<div class="page-stack">
    <a class="back-link" href="{{ route('patients.index') }}" wire:navigate><span aria-hidden="true">←</span> Patients</a>
    ...
    @if ($loadingFailed)
        <section class="empty-state" role="alert">
            ...
            <p>{{ $message }}</p>
            <div class="button-row"><a class="secondary-button" href="{{ route('patients.index') }}" wire:navigate>Back to patients</a><button class="text-button" type="button" wire:click="retry">Try again</button></div>
        </section>
    @else
        @php
        ...
        <header class="patient-hero">
            ...
            @if (($capabilities['submit_care'] ?? false) === true)
                <a class="primary-button" href="{{ route('patients.submissions.create', ['grantId' => $grantId]) }}" wire:navigate>Submit care records</a>
            @endif
        </header>
            ...
            @else
                <div class="media-grid">
                    @foreach ($media as $item)
                        @php $mediaUrl = route('patients.media.show', ['grantId' => $grantId, 'mediaId' => $item['id']]); @endphp
